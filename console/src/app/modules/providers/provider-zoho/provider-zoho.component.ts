...
@Component({
  selector: 'cnsl-provider-zoho',
  templateUrl: './provider-zoho.component.html',
  styleUrls: ['./provider-zoho.component.scss'],
})
export class ProviderZohoComponent {
  ...
  private getData(id: string): void {
    ...
    this.service
      ...
      .then((resp) => {
        ...
        this.loading = false;
        if (this.provider?.config?.zoho) {
          this.form.patchValue(this.provider.config.zoho);
